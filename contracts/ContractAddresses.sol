...
library ContractAddresses {
    ...
    address internal constant GAME_ENDGAME_MODULE = address(0x212224D2F2d262cd093eE13240ca4873fcCBbA3C);
    address internal constant GAME_GAMEOVER_MODULE = address(0x2a07706473244BC757E10F2a9E86fB532828afe3);
    address internal constant GAME_LOOTBOX_MODULE = address(0x3D7Ebc40AF7092E3F1C81F2e996cbA5Cae2090d7);
    address internal constant GAME_BOON_MODULE = address(0xD16d567549A2a2a2005aEACf7fB193851603dd70);
    address internal constant GAME_DEGENERETTE_MODULE = address(0x96d3F6c20EEd2697647F543fE6C08bC2Fbf39758);
    address internal constant COIN = address(0x13aa49bAc059d709dd0a18D6bb63290076a702D7);
    address internal constant COINFLIP = address(0xDB25A7b768311dE128BBDa7B8426c3f9C74f3240);
    address internal constant VAULT = address(0x796f2974e3C1af763252512dd6d521E9E984726C);
    address internal constant AFFILIATE = address(0x1aF7f588A501EA2B5bB3feeFA744892aA2CF00e6);
