...
contract IconRendererRegular32 {
    ...
    /// @dev Callable only by bongs; set-once semantics. Optional extra addresses are registered as allowed
    ///      token contracts in the color registry (e.g., trophies, bongs).
