...
║  │   _paths[16-23] ─► Quadrant 2 (Gambling): Dice, Cards, Chips, etc.                              │ ║
║  │   _paths[24-31] ─► Quadrant 3 (Dice):     Dice faces 1-8                                        │ ║
...
║  │   _symQ3[0-7]   ─► Gambling symbol names: "Dice", "Cards", etc.                                 │ ║
║  │   (Q4 Dice names are generated dynamically: "Dice 1", "Dice 2", etc.)                           │ ║
║  └──────────────────────────────────────────────────────────────────────────────────────────────────┘ ║
║                                                                                                       ║
║  DESIGN RATIONALE                                                                                     ║
║  ────────────────                                                                                     ║
...
contract Icons32Data {
    ...
    /// @dev Human-readable symbol names for Quadrant 2 (Gambling)
    ///      Examples: "Dice", "Cards", "Chips", "Slot"
    string[8] private _symQ3;

    // Note: Quadrant 3 (Dice) names are generated dynamically as "Dice 1" through "Dice 8"
    ...
    /// @param symQ3_ Array of 8 symbol names for Quadrant 2 (Gambling)
    constructor(
    ...
    /// @dev Quadrant 3 (Dice) returns empty string; renderer generates "Dice N" dynamically
    ...
    function symbol(uint256 quadrant, uint8 idx) external view returns (string memory) {
        ...
        // Quadrant 3 (Dice) names are generated by the renderer as "Dice N"
        return "";
    }
}
