...
The complete, unmodified Solidity source for every contract in the [Degenerus Protocol](https://degener.us) — a fully on-chain elimination game on Ethereum where the last players standing split the pot.
