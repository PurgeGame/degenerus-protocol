...
**Plans**: 3 plans (single wave — all 3 parallel per 239-CONTEXT.md D-01/D-02)
  - [ ] 239-01-PLAN.md — RNG-01 `rngLockedFlag` state machine airtight proof (wave 1, parallel with 239-02 + 239-03). Output `audit/v30-RNGLOCK-STATE-MACHINE.md`: Set-Site Table + Clear-Site Table + Path-Enumeration Table + Invariant Proof + Finding Candidates per D-04; closed verdict taxonomy {AIRTIGHT / CANDIDATE_FINDING} per D-05; L1700 revert-safety per D-06; 12h retry-timeout per D-07. Discharges Phase 238-03 rngLocked audit assumption per D-29.
