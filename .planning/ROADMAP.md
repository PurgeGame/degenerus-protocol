...
- [x] **Phase 235: Conservation + RNG Commitment Re-Proof + Phase Transition** - ETH + BURNIE conservation across the delta, RNG commitment-window re-proof for every new consumer, and phase-transition RNG lock removal audit — completed 2026-04-18 (5/5 plans shipped; 41 SSTORE catalog rows + 10 path proofs for CONS-01; 10 mint + 6 burn sites for CONS-02; 28 backward-trace rows for RNG-01; 19 per-site commitment-window rows + global state-var enumeration for RNG-02; 4-path walk + buffer-swap site at AdvanceModule:292 for TRNX-01; zero VULNERABLE / zero DEFERRED / zero Finding Candidate: Y across all 5 plans)
...
- [x] 235-01-PLAN.md — Produce 235-01-AUDIT.md: CONS-01 ETH conservation Per-SSTORE Catalog + Per-Path Algebraic Proofs + 232.1 Ticket-Processing Impact sub-section per D-06; cross-cites 231-01 EBD-01 / 231-02 EBD-02 / 231-03 EBD-03 / 232-01 DCM-01 re-verified at HEAD 1646d5af per D-04 — completed 2026-04-18 (41 SSTORE rows + 10 named-path algebraic proofs; zero VULNERABLE / zero DEFERRED / zero Finding Candidate: Y; commits 6e09cdca + 950cc7f5)
- [x] 235-02-PLAN.md — Produce 235-02-AUDIT.md: CONS-02 BURNIE conservation Per-Mint-Site + Per-Burn-Site Catalogs + Quest Credit Algebra + 232.1 Ticket-Processing Impact sub-section; cross-cites 232-01 DCM-01 + 234-01 QST-01/02/03 re-verified at HEAD 1646d5af — completed 2026-04-18 (10 mint-site rows + 6 burn-site rows; zero VULNERABLE / zero DEFERRED / zero Finding Candidate: Y; commits 9e93cd3a + fa9eaf77)
- [x] 235-03-PLAN.md — Produce 235-03-AUDIT.md: RNG-01 Per-Consumer Backward-Trace Table covering 5 consumer categories (earlybird bonus-trait, BAF sentinel, entropy passthrough, 17 per-site c2e5e0a9 rows per D-07, 314443af keccak-seed per D-09) + D-09 Non-Zero-Entropy Availability Cross-Cite to 232.1-03-PFTB-AUDIT + 232.1 Ticket-Processing Impact sub-section; cross-cites 233-02 JKP-02 + 231-02 EBD-02 + 232.1-03-PFTB-AUDIT re-verified at HEAD 1646d5af — completed 2026-04-18 (28 backward-trace rows including 19 c2e5e0a9 + 314443af keccak-seed verdict; zero VULNERABLE / zero DEFERRED / zero Finding Candidate: Y; commits 23f9c8ca + 0e963b05)
- [x] 235-04-PLAN.md — Produce 235-04-AUDIT.md: RNG-02 Per-Consumer Commitment-Window Enumeration Table covering 5 consumer categories (17 per-site c2e5e0a9 rows per D-08 + 314443af per D-09) + rngLocked Invariant sub-section with D-11 citation + Global State-Variable Enumeration + D-09 Availability Cross-Cite + 232.1 Ticket-Processing Impact sub-section; cross-cites 233-02 JKP-02 D-06 + 232.1 Plan 02 forge invariants re-verified at HEAD 1646d5af — completed 2026-04-18 (19 c2e5e0a9 rows + global state-var enumeration of 25 variables + D-11 invariant sub-section; zero VULNERABLE / zero DEFERRED / zero Finding Candidate: Y; commits 4f1a5233 + 0e963b05)
- [x] 235-05-PLAN.md — Produce 235-05-AUDIT.md: TRNX-01 D-11 rngLocked invariant verbatim statement + Buffer-Swap Site Citation at concrete file:line per D-12 + 4-Path Walk Table (Normal / Gameover / Skip-split / Phase-transition freeze per D-13) + rngLocked End-State Check + 232.1 Ticket-Processing Impact sub-section walking 6 fix-series changes; cross-cites 232.1-01-FIX + 232.1-02 forge invariants re-verified at HEAD 1646d5af — completed 2026-04-18 (4-path walk all SAFE + buffer-swap site cited at `DegenerusGameAdvanceModule.sol:292` `_swapAndFreeze` at RNG request time + 7 232.1 fix-series sub-sections; zero VULNERABLE / zero DEFERRED / zero Finding Candidate: Y; commits 0006a014 + 950cc7f5)
...
- [x] 236-01-PLAN.md — Produce `audit/FINDINGS-v29.0.md` (new file, v27.0-style): Executive Summary (0/0/0/0/4 per D-04) + per-phase subsections (231/232/232.1/233/234/235 in phase order per D-02) + 4 F-29-NN INFO blocks (F-29-01/02 BAF event-widening per D-05; F-29-03 QST-01 FC-234-A companion-test-coverage; F-29-04 Gameover RNG substitution per D-06/D-07); update KNOWN-ISSUES.md with 2 new design-decision entries (BAF pattern + Gameover RNG substitution) + 3 targeted v29.0 back-refs on existing entries per D-08 (Gameover prevrandao fallback; Lootbox RNG index advance isolation; Decimator settlement over-reserves claimablePool) — completed 2026-04-18 (166-line FINDINGS-v29.0.md with 4 F-29-NN INFO blocks 0/0/0/0/4; KNOWN-ISSUES.md +7/-3 lines with 2 new entries + 3 back-refs; all 46 automated acceptance gates passed across both tasks; commits 519b57e8 + 5de8ad0c; see `.planning/phases/236-regression-findings-consolidation/236-01-SUMMARY.md`). Satisfies FIND-01, FIND-02, and the Executive-Summary portion of FIND-03.
...
| 235. Conservation + RNG Commitment Re-Proof | 5/5 | Complete | 2026-04-18 |
| 236. Regression + Findings Consolidation | 1/2 | Executing | — |
