...
**Active milestone:** v40.0 — Unified Whole-Ticket Award Protocol (started 2026-05-13)
...
---
*Last updated: 2026-05-13 — v40.0 milestone OPEN (Unified Whole-Ticket Award Protocol). Audit baseline: v39.0 closure HEAD `MILESTONE_V39_AT_HEAD_6a7455d1`. Multi-phase shape (surface-split + terminal audit) per v33/v34/v35/v37 precedent. Target features: auto-resolve LootboxModule Bernoulli + JackpotModule:2216 BAF Bernoulli + event surface unification (drop `LootboxTicketRoll`, fold into existing events, retire `index != type(uint48).max` sentinel) + JackpotModule cosmetic cleanup + ENT-05 BAF xorshift refactor + terminal audit deliverable. Decision-anchor IDs: D-40N-GRANULARITY-01 (TICKET granularity settled) + D-40N-SILENT-01 (auto-resolve + jackpot silent on cold-bust) + D-40N-EVT-BREAK-01 (breaking topic-hashes accepted) + D-40N-MINTBOOST-OUT-01 (mint-boost retention) + D-40N-SENTINEL-RETIRE-01 (index sentinel retirement). Detailed v37.0 + v38.0 + v39.0 milestone records in `.planning/MILESTONES.md` + `.planning/STATE.md` "Last Shipped Milestone" block.*
