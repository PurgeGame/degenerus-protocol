...
**Active milestone:** v45.0 (REDEFINED 2026-05-22) — VRF-Rotation Liveness Fix + Consolidate-Forward Delta Audit. Phases 309/310 (V-081 lootbox EV-cap) complete as groundwork; 311 (SPEC) / 312 (IMPL — VRF-rotation orphan-index fix `a303ae18`) / 313 (TST — VRF regression + freeze-invariant fuzz, 7 plans, VERIFICATION passed 5/5, zero `contracts/` mutation) complete; active work continues at Phase 314 (SWEEP). Consumes the `audit/FINDINGS-v44.0.md` §9d VRF-governance cluster (HANDOFF-78/85/86/87/88/89/90/91 + ADMA-01/02) as load-bearing input; the remaining ~115 backlog anchors stay deferred.
**Last shipped:** v44.0 — sStonk Per-Day Redemption Refactor + Accounting Invariant Proof (2026-05-20; closure signal `MILESTONE_V44_AT_HEAD_6f0ba2963a10654ba554a8c333c5ee80c54a8349`; 7 of 7 SSTONK_VIOLATIONS RESOLVED_AT_V44; 13 of 13 INVARIANTS PROVEN; 20 of 20 EDGE_CASES TESTED; 0 NEW_FINDINGS; 135-anchor v45.0+ handoff register; KNOWN_ISSUES_UNMODIFIED)
