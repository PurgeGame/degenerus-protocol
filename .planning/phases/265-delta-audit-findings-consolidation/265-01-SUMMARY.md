...
| AUDIT-06 | `JackpotBurnieWin.lvl` semantic-shift surfaced in §3c prose + KNOWN-ISSUES.md +1 entry under Design Decisions (after Lido stETH dependency) | ✓ |
...
- **D-265-AUDIT06-01** — §3c prose + §6b D-09 PASS row + KNOWN-ISSUES.md +1 entry under Design Decisions (after Lido stETH dependency). ✓
...
- `KNOWN-ISSUES.md` (+1 entry under "## Design Decisions" subsection — JackpotBurnieWin.lvl semantic shift)
