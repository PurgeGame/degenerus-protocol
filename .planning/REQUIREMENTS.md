...
- [x] **JACK-03**: Document 5-day jackpot-phase draw mechanics with daily pool slice formulas (6-14% random, 100% day 5)
- [x] **JACK-04**: Document trait bucket distribution and winner selection per jackpot-phase day
- [x] **JACK-05**: Document carryover ETH mechanics and compressed jackpot conditions
- [x] **JACK-06**: Document lootbox conversion ratios (50% daily, 75% reward jackpots)
- [x] **JACK-07**: Document BURNIE jackpot-phase parallel distribution and far-future allocation
- [x] **JACK-08**: Document BAF mechanics (every 10 levels, future pool percentages, lootbox conversion) at jackpot-phase transition
- [x] **JACK-09**: Document decimator mechanics (level triggers, multiplier tiers, BURNIE burn requirements) at jackpot-phase transition

### BURNIE Economics

- [x] **BURN-01**: Document coinflip mechanics (stake, odds, payout range, bounty system, expiry)
- [x] **BURN-02**: Document BURNIE earning paths (lootbox bonuses, quest rewards, coinflip winnings)
- [x] **BURN-03**: Document BURNIE burn sinks (decimator eligibility, ticket purchases)
- [x] **BURN-04**: Document vault reserve mechanics and supply invariants
...
| JACK-03 | Phase 7 | Complete |
| JACK-04 | Phase 7 | Complete |
| JACK-05 | Phase 7 | Complete |
