...
- [x] **DCOIN-01**: Coin jackpot winner selection path documented with file:line (including _awardFarFutureCoinJackpot)
- [x] **DCOIN-02**: Ticket jackpot winner selection path documented with file:line
- [x] **DCOIN-03**: jackpotCounter lifecycle (initialization, increment, read, reset) fully traced
