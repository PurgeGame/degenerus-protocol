...
- [ ] **CEIL-01**: Worst-case gas for _processDailyEthChunk profiled (321 winners, all auto-rebuy, 4 populated buckets)
- [ ] **CEIL-02**: Worst-case gas for payDailyJackpot profiled (Phase 0 + Phase 1 combined, final physical day)
- [ ] **CEIL-03**: All profiled paths SAFE under 14M gas ceiling with headroom documented
...
| CEIL-01 | Phase 96 | Pending |
| CEIL-02 | Phase 96 | Pending |
