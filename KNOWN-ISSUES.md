...
Frozen subject: `contracts/` tree `0320e3d3` @ tag `degenerus-c4a`. Pre-scanned with Slither v0.11.5
...
The full machine-readable Slither/Aderyn baseline is maintained internally — Slither 0.11.5 (2,890
results / 101 detectors at tree `0320e3d3`; the 146 "High" are dominated by `uninitialized-state`
...
These counts were measured directly at tree `0320e3d3`, not carried forward from an earlier scan.
CI re-runs both
