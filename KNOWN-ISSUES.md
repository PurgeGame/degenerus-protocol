...
Frozen subject: `contracts/` tree `06183948` @ tag `degenerus-c4a`. Pre-scanned with Slither v0.11.5
...
results / 101 detectors at tree `06183948`; the 141 "High" are dominated by `uninitialized-state`
