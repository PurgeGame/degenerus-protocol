...
| Extended unattended advance | Gap backfill is capped at 120 skipped days per advance (`_backfillGapDays`). Days beyond that cap in one stall receive no derived word, so their coinflip positions may remain unresolved. |
