...
Frozen subject: `contracts/` tree `a82caade` @ tag `degenerus-c4a`. Pre-scanned with Slither v0.11.5
...
results / 101 detectors at tree `a82caade`; the 141 "High" are dominated by `uninitialized-state`
