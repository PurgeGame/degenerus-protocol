...
Frozen subject: `contracts/` tree `d6abb363` @ tag `degenerus-c4a`. Pre-scanned with Slither v0.11.5
...
0.11.5 (2,877 results / 101 detectors; the 139 "High" are dominated by `uninitialized-state` false
