...
async function main() {
  ...
  console.log("Funding VRF subscription with 20 LINK...\n");
  
  const linkAbi = ["function transferAndCall(address to, uint256 value, bytes calldata data) returns (bool)"];
  ...
  await tx.wait();
  console.log("✅ Sent 20 LINK to Admin - subscription will be auto-funded");
}
