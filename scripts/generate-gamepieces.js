...
function renderContractAddresses(constants) {
  const lines = [
...
async function maybePrecomputeConstants(deployer) {
  ...
  const outputPath = path.resolve("contracts/ContractAddresses.sol");
  fs.writeFileSync(outputPath, renderContractAddresses(constants), "utf8");
