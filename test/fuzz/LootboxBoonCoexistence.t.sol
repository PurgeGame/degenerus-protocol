...
contract LootboxBoonCoexistence is DeployProtocol {
    ...
    uint256 constant SLOT_BOON_PACKED     = 65;   // mapping(address => BoonPacked)
    uint256 constant SLOT_LOOTBOX_ETH     = 15;   // mapping(uint48 => mapping(address => uint256))
    uint256 constant SLOT_LOOTBOX_RNG_IDX = 38;   // lootboxRngPacked (low 48 bits = lootboxRngIndex)
    uint256 constant SLOT_LOOTBOX_WORD    = 39;   // mapping(uint48 => uint256) lootboxRngWordByIndex
    uint256 constant SLOT_LOOTBOX_DAY     = 40;   // mapping(uint48 => mapping(address => uint48))
    uint256 constant SLOT_LOOTBOX_BASE    = 21;   // mapping(uint48 => mapping(address => uint256))
    uint256 constant SLOT_LOOTBOX_EV      = 42;   // mapping(uint48 => mapping(address => uint16))
