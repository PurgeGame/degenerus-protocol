...
contract RngLockRotationDeterminism is DeployProtocol {
    ...
    uint256 private constant SLOT_LOOTBOX_RNG_INDEX = 35;          // post V62 lootbox repack: was 36
    uint256 private constant SLOT_LOOTBOX_RNG_WORD_BY_INDEX = 36;  // post V62 lootbox repack: was 37
