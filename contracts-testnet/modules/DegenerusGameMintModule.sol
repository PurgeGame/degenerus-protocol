...
contract DegenerusGameMintModule is DegenerusGameStorage {
    ...
    uint256 private constant LOOTBOX_MIN = 0.01 ether / D;
    /// @dev BURNIE loot box minimum purchase amount (scaled for testnet).
    uint256 private constant BURNIE_LOOTBOX_MIN = 1000 ether; // BURNIE, not ETH
    /// @dev Absolute minimum ticket buy-in (ETH equivalent).
    uint256 private constant TICKET_MIN_BUYIN_WEI = 0.0025 ether / D;
